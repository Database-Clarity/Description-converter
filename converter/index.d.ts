import { CellContent, Database, DescriptionData, DescriptionLine, IntermediatePerk, LinesContent, PerkTypes, PossiblePerkLinks, RowContent, Stat, Stats, TableLine } from './src/interfaces';
